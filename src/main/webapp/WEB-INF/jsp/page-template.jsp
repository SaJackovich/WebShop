...
<head>
	...
	<link href="${pageContext.request.contextPath}/main/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<link href="${pageContext.request.contextPath}/main/css/style.css" rel="stylesheet" type="text/css" media="all" />
	<link rel="stylesheet" href="${pageContext.request.contextPath}/main/css/fontawesome-all.css">
	<link href="${pageContext.request.contextPath}/main/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<link href="${pageContext.request.contextPath}/main/css/menu.css" rel="stylesheet" type="text/css" media="all" />

    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/main/foundation.css"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/main/foundation-icons.css"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/main/app.css"/>
...
<body>
		...
		<div class="container-fluid">
			<div class="row main-top-w3l py-2">
				<div class="col-lg-4 header-most-top">
					<p class="text-white text-lg-left text-center"><fmt:message key="offer.zone"/>
					...
					<ul>
						<li class="text-center border-right text-white">
							<a href="#" data-toggle="modal" data-target="#exampleModal" class="text-white">
								<i class="fas fa-truck mr-2"></i><fmt:message key="order"/></a>
						</li>
						<li class="text-center border-right text-white">
				...
				<div class="col-md-3 logo_agile">
					<h1 class="text-center">
						<a href="index.html" class="font-weight-bold font-italic">
							<img src="${pageContext.request.contextPath}/main/images/logo2.png" alt=" " class="img-fluid">Electro Store
						</a>
					</h1>
				</div>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						<li class="nav-item active mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link" href="${pageContext.request.contextPath}/main">Home
	...
	<footer>
    	...
    	<script src="${pageContext.request.contextPath}/main/js/jquery-2.2.3.min.js"></script>
    	<script>
    	...
    	<script src="${pageContext.request.contextPath}/main/js/jquery.magnific-popup.js"></script>
    	<script>
    		$(document).ready(function () {
    	...
    	<script src="${pageContext.request.contextPath}/main/js/minicart.js"></script>
    	<script>
    		...
    		paypals.minicarts.cart.on('checkout', function (evt) {
    			...
    			if (total < 3) {
    				alert('The minimum order quantity is 3. Please create more to your shopping cart before checking out');
    				evt.preventDefault();
    			}
    		});
    	</script>
    	...
    	<script src="${pageContext.request.contextPath}/main/js/scroll.js"></script>
    	<script src="${pageContext.request.contextPath}/main/js/SmoothScroll.min.js"></script>
    	<script src="${pageContext.request.contextPath}/main/js/move-top.js"></script>
    	<script src="${pageContext.request.contextPath}/main/js/easing.js"></script>
    	<script>
    	...
    	<script src="${pageContext.request.contextPath}/main/js/bootstrap.js"></script>
