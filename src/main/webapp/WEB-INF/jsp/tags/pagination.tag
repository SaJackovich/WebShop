...
<%@ attribute name="pagination" required="true" type="web.pagination.Pagination" %>
...
<c:if test="${pagination != null}">
    <ul class="pagination text-center" role="navigation" aria-label="Pagination" style="align-items: center; justify-content: center;">
