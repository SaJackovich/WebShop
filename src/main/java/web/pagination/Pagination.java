...
public final class Pagination {
    ...
    /**
     * Use new Pagination.Builder() to productsBuild Pagination instance
     */
    ...
    public static class Builder {
        ...
        private void baseUrlInit(String baseUrl){
            int pageIndexInUrl = baseUrl.indexOf("page");
            if (pageIndexInUrl != -1) {
                this.baseUrl = baseUrl.substring(0, pageIndexInUrl);
            } else {
